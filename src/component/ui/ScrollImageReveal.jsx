        ...
        >
            ...
            <div className="relative container mx-auto px-4 flex flex-col md:flex-row gap-6 z-10">
                ...
                <div className="flex-1 bg-white p-6 shadow rounded">
                    ...
                    <p className="font-poppins-regular">We provide Home services since <span className="text-red-400 font-bold">2012</span> in <span className="text-red-400 font-bold">Kanpur, Uttar Pradesh</span></p>
                </div>
            </div>
        </section>
    );
